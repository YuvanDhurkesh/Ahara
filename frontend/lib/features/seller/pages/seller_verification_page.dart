  ...
  void _verifyFinal() async {
    ...
    try {
      ...
      await BackendService.verifyAadhaarMock(
        ...
        name: auth.mongoUser?['name'] ?? "Seller",
      );
  ...
  Widget _buildVerificationForm() {
    return Column(
      ...
      children: [
        Text(
          "Get Verified",
          style: GoogleFonts.lora(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.textDark),
        ),
        const SizedBox(height: 8),
        Text(
          "Verified sellers build trust across our community and reach more buyers.",
              ...
              if (!_isAadhaarSubmitted) ...[
                ...
                Center(
                  child: TextButton(
                    ...
                    child: Text("Change Aadhaar Number", style: TextStyle(color: AppColors.primary, fontFamily: GoogleFonts.lora().fontFamily)),
                  ),
                ),
              ],
            ],
  ...
  Widget _buildSuccessState() {
    return Column(
      ...
      children: [
        ...
        const Text(
          "Your identity certificate has been processed. Trust badge level 1 added to your profile.",
          textAlign: TextAlign.center,
          style: TextStyle(color: Colors.grey),
        ),
        const SizedBox(height: 48),
        _buildButton("Go to Dashboard", () {
        ...
        return Container(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(
              counterText: "",
              filled: false, // Disable theme-level background
              border: InputBorder.none,
